...
script.on_event("spidertron-enhancements-use-alt-spidertron-remote",
  function(event)
    ...
    if player then
      ...
      if cursor_item and cursor_item.valid_for_read and (cursor_item.type == "rts-tool" and cursor_item.name ~= "sp-spidertron-patrol-remote") and player.rts_selection then
        for _, spidertron in pairs(player.rts_selection) do
